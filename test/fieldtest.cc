...
void
diffRootInvRoot(const RandomField& field)
{
...
template<typename RandomField>
void
diffRootRootInv(const RandomField& field)
{
  const double fieldNorm = std::sqrt(field * field);
  RandomField copy(field);
  copy.timesMatrixRoot();
...
template<typename RandomField>
void
diffInvRootRoot(const RandomField& field)
{
  const double fieldNorm = std::sqrt(field * field);
  RandomField copy(field);
  copy.timesInverseMatrix();
...
template<typename RandomField>
void
diffInvMult(const RandomField& field)
{
  const double fieldNorm = std::sqrt(field * field);
  RandomField copy(field);
  copy.timesInverseMatrix();
...
template<typename RandomField>
void
diffMultInv(const RandomField& field)
{
  const double fieldNorm = std::sqrt(field * field);
  RandomField copy(field);
  copy.timesMatrix();
...
main(int argc, char** argv)
{
  try {
    ...
    static_assert(DIMENSION >= 1 && DIMENSION <= 4,
                  "only dimension 1, 2, 3 and 4 supported!");
